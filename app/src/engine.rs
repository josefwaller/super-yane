...
use crate::{audio::Audio, emulation::Emulation, menu::spawn_menu_thread};
...
impl Engine {
    pub fn new(emulation: Arc<Mutex<Emulation>>) -> Engine {
        ...
        let thread_closure = closure!(clone emulation, || {
            {
